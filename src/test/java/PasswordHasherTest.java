...
public class PasswordHasherTest {
    ...
    @Test
    public void hashPBKDF2WithHmac256() {
        char[] pwd = password.toCharArray();
        byte[] hashToVerify = passwordHasher.hashPBKDF2WithHmac256(pwd, salt, cost, dklen);
        assertArrayEquals("incorrect hash", hash, hashToVerify);
        assertArrayEquals("password not zeroed out", zeroFilledCharArray(pwd.length), pwd);
